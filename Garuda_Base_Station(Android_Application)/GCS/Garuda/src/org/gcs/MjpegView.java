...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public Bitmap[] video = new Bitmap[150];
                        ...
                        synchronized (mSurfaceHolder) {
                            try {
                                ...
                                if(bm != null)
                                    {kvl = bm;}
                                if(isRec && i < 100)
                                    { Log.e("aaaa","Value of i " + i);
                                      video[i++] = bm;
                                    }
                                else
                                {Log.e("aaaaa","Recording not on");
                                }
                                if (showFps) {
                                    p.setXfermode(mode);
                                    if (ovl != null) {
